...
namespace Blogs.BLL
{
	...
	{
		private readonly Blogs.DAL.EnumerationDAL dal=new Blogs.DAL.EnumerationDAL();
		...
		{
			return dal.DeleteList(Maticsoft.Common.PageValidate.SafeLongFilter(e_idlist,0) );
		}
